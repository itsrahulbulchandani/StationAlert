  ...
  return (
    <TabContext.Provider value={{
      ...
      <SafeAreaView style={styles.safeArea}>
        <StatusBar barStyle="dark-content" backgroundColor="#F3F6F9"/>
        ...
        <View style={styles.tabContainer}>
          <TouchableOpacity
            ...
            style={[styles.tabButton, activeTab === 'search route' && styles.activeTabButton]}
          >
            <Text style={[styles.tabText, activeTab === 'search route' && styles.activeTabText]}>Search Route</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => setActiveTab('route')}
            style={[styles.tabButton, activeTab === 'route' && styles.activeTabButton]}
          >
            <Text style={[styles.tabText, activeTab === 'route' && styles.activeTabText]}>Route Map</Text>
          </TouchableOpacity>
        </View>
